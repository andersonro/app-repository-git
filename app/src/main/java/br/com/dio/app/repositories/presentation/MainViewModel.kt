...
class MainViewModel(private val listUserRepositiryUseCase: ListUserRepositiryUseCase): ViewModel() {
    ...
    fun getRepositoryList(user: String) {
        viewModelScope.launch {
            listUserRepositiryUseCase.execute(user)
                .onStart {
    ...
    sealed class State{
        ...
        data class Success(val list: List<Repositores>): State()
